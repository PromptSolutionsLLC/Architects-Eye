const THEATERS = [
  ...
  "Korean DMZ",
  "California Wildfire Belt",
] as const;

function flyToTheater(name: string): void {
  // P7 will wire this to an actual camera flyTo in Viewer.
  // eslint-disable-next-line no-console
  console.log(`[Theater] flyToTheater(${name})`);
}
